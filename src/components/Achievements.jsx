...
export default function Achievements() {
  ...
  return (
    <section id="achievements" className="relative py-20 lg:py-28 bg-black overflow-hidden">
      ...
      <div className="absolute top-1/2 right-1/4 w-[400px] max-w-full h-[400px] bg-[#C9A876]/[0.03] blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="group relative p-6 sm:p-10 rounded-[2rem] bg-[#09090B] border border-[#27272A] overflow-hidden hover:border-[#52525B] shadow-[0_8px_30px_rgba(0,0,0,0.5)] transition-all duration-500"
          >
            ...
            <div className="absolute top-0 right-0 p-8 sm:p-12 opacity-5 group-hover:opacity-10 transition-opacity duration-500 pointer-events-none transform group-hover:scale-105 text-[#E8D2A6]">
              <Trophy className="w-32 h-32 sm:w-40 sm:h-40" />
            </div>

            <div className="relative z-10 max-w-2xl">
              {/* Header */}
              <div className="flex items-center gap-4 mb-6">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-[#E8D2A6] shrink-0 group-hover:bg-[#C9A876]/15 group-hover:border-[#C9A876]/30 transition-colors">
              ...
              {/* Description */}
              <p className="text-white/70 text-sm sm:text-base font-light leading-relaxed mb-7">
                {item.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2.5">
                {item.badges.map((badge, bIdx) => (
                  <div
                    key={bIdx}
                    className="px-3 py-1.5 rounded-lg bg-[#18181B] border border-[#27272A] text-white/80 font-mono text-[10px] uppercase tracking-wider flex items-center gap-2"
                  >
